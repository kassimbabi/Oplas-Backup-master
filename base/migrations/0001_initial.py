    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LevelName', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.schoollevels', verbose_name='Level Name')),
                ('SubjectName', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.subjects', verbose_name='Subject Name')),
                ('ApprovedBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approvedby', to='base.teachers', verbose_name='Approved By')),
                ('QuestionBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questionby', to='base.teachers', verbose_name='Question By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AnswerBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answerby', to='base.teachers', verbose_name='Answer By')),
                ('ApprovedBy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='approveby', to='base.teachers', verbose_name='Approved By')),
            ],
            options={
                'verbose_name': 'Answer',
